...
export const createQueryPreloader = wrap('createQueryPreloader');
...
export const useLoadableQuery = wrap('useLoadableQuery');
export const useMutation = wrap('useMutation');
export const useQuery = wrap('useQuery');
export const useQueryRefHandlers = wrap('useQueryRefHandlers');
...
export const useSuspenseFragment = wrap('useSuspenseFragment');
