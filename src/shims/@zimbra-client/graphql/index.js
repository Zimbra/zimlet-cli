...
export const GetCustomMetadataQuery = wrap('GetCustomMetadataQuery');
...
export const GetFilterRules = wrap('GetFilterRules');
export const modifyFilterRules = wrap('modifyFilterRules');
export const cloneWithoutTypeName = wrap('cloneWithoutTypeName');
