...
export const flushSync = wrap('flushSync');
...
export const startTransition = wrap('startTransition');
...
export const useDeferredValue = wrap('useDeferredValue');
export const useInsertionEffect = wrap('useInsertionEffect');
export const useSyncExternalStore = wrap('useSyncExternalStore');
export const useTransition = wrap('useTransition');
